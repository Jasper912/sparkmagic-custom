...
PACKAGES            = ['sparkmagic',
                       ...
                       'sparkmagic/kernels/sparksqlkernel',
                       'sparkmagic/kernels/wrapperkernel',
                       'sparkmagic/utils',
                       'sparkmagic/serverextension']
AUTHOR              = "jasper0912@icloud.com"
AUTHOR_EMAIL        = "jasper0912@icloud.com"
URL                 = 'https://github.com/Jasper912/sparkmagic.git'
DOWNLOAD_URL        = 'https://github.com/Jasper912/sparkmagic.git'
...
_package_data = {
    'sparkmagic': [
        ...
        'kernels/sparksqlkernel/kernel.js',
        ...
        'kernels/sparksqlkernel/kernel.json'
    ]
}
