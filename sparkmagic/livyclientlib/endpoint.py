...
def build_endpoint(session_language):
    credential_key = 'base64_kernel_%s_credentials' % session_language
    credentials = getattr(conf, credential_key)()
    endpoint = Endpoint(
        credentials['url'], credentials['auth'],
