...
class SparkStoreCommand(Command):
    ...
    def to_command(self, kind, spark_context_variable_name):
        ...
        elif kind == constants.SESSION_KIND_SQL:
            return self._sql_command(sql_context_variable_name)
        else:
    ...
    def _sql_command(self, sql_context_variable_name):
        command = u"{}".format(sql_context_variable_name)
        return Command(command)
