...
class RemoteSparkMagics(SparkMagicBase):
    ...
    def manage_spark(self, line, local_ns=None):
        ...
        #Disabled %manage_spark ,origin code: return self.manage_widget
        return None
    ...
    def spark(self, line, cell="", local_ns=None):
        ...
        # 初始化livysession
        init_session_name=self.init_livy_session(self.shell.kernel.session_language)
        if not args.session:
            args.session=init_session_name
