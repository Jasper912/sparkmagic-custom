...
SESSION_KINDS_SUPPORTED = [SESSION_KIND_SPARK, SESSION_KIND_PYSPARK,
                           SESSION_KIND_PYSPARK3, SESSION_KIND_SPARKR,
                           SESSION_KIND_SQL]
...
LANG_R = "r"
LANG_SQL = "sql"
LANGS_SUPPORTED = [LANG_SCALA, LANG_PYTHON, LANG_PYTHON3, LANG_R, LANG_SQL]
...
HEALTHY_SESSION_STATUS = [IDLE_SESSION_STATUS, STARTING_SESSION_STATUS,
                           BUSY_SESSION_STATUS, SUCCESS_SESSION_STATUS]
...
SESSION_CONF_PARAM = u"conf"
SPARK_YARN_QUEUE_PARAM = u"spark.yarn.queue"

LIVY_INFO_PATH = "/opt/livy/"
